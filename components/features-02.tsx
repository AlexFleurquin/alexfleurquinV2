                        ...
                        <div className="mb-5">
                          <div>
                            ...
                            <p className="text-slate-400">
                              maestro dans l'art de définir une vision produit
                              convaincante et inspirante. En comprenant les
                              besoins des utilisateurs et les tendances du
                              marché, je suis capable de concevoir des produits
                              qui repoussent les limites de l'innovation et qui
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          ...
                          <p className="text-slate-400">
                            Je sais comment poser les bonnes questions et mener
                            des recherches approfondies pour identifier les
                            besoins non satisfaits des utilisateurs et découvrir
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          ...
                          <p className="text-slate-400">
                            Je suis un gestionnaire de projet chevronné, capable
                            de coordonner efficacement les équipes
                            interfonctionnelles pour respecter les délais et
                            garantir une qualité supérieure à chaque étape du
                            processus.
                          </p>
                        </div>
                      </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">APIs de Pointe</h4>
              </div>
              <p className="text-sm text-slate-400">
                Création des interfaces robustes, sécurisées et hautement
                performantes qui offrent une connectivité transparente et une
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Design Thinking</h4>
              </div>
              <p className="text-sm text-slate-400">
                utilisateur au cœur du processus de conception. En collaborant
                étroitement avec les équipes de design, je m'assure que votre
                produit offre une expérience utilisateur intuitive, attrayante
                et mémorable.
              </p>
            </div>
            {/* Feature */}
