export const metadata = {
  title: 'Changelog - Alex Fleurquin',
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="pt-32 pb-12 md:pt-40 md:pb-20">
            ...
            <div className="text-center pb-12 md:pb-20">
              <h1 className="h1 font-bricolage font-bold bg-gradient-to-r text-transparent bg-clip-text from-blue-400 to-orange-200 pb-4">
                What's new
              </h1>
              <div className="max-w-3xl mx-auto">
                <p className="text-lg text-slate-400 font-bricolage">
                  Nouvelles et améliorations du portfolio.
                </p>
              </div>
            </div>
